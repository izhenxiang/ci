...
var A = (e, r, t) =>
	r in e ? R(e, r, { enumerable: !0, configurable: !0, writable: !0, value: t }) : e[r] =
		t,
	B = (e, r) => {
		for (var t in r || (r = {})) q.call(r, t) && A(e, t, r[t]);
		if (D) {
			for (var t of D(r)) W.call(r, t) && A(e, t, r[t]);
		}
		return e;
	};
import { c as n, m as G } from "./5.js";
import { i as k } from "./4.js";
import {
	H
	as
	E,
...
import { z as ee } from "./_.js";
import { b as re } from "./a.js";
import { s as oe } from "./1.js";
import { v as te } from "./3.js";
import { H as M } from "./$.js";
import "./7.js";
import "./2.js";
import "./0.js";
import "./x.js";
...
var ce = y(ae, [["render", le], ["__scopeId", "data-v-1eb91dd6"]]),
	ue = {
		setup: () => ({
			config: n,
			disabled: K(() => n.src === "camera"),
			li: "\u6574\u4E2A\u684C\u9762 \u6307\u5B9A\u533A\u57DF".split(" "),
		}),
	};
const _e = (e) => (I("data-v-2a229f8c"), e = e(), C(), e),
	ve = { class: "bk" },
...
var be = y(ue, [["render", ge], ["__scopeId", "data-v-2a229f8c"]]),
	$e = {
		components: { zAudio: ee },
		setup: () => {
			var e, r, t;
			return (
				t = { audio: V([]), video: V([]) }, { mediaDevices: e } = navigator, r =
					async () => {
...
var Me = y(Be, [["render", Te], ["__scopeId", "data-v-b0e482fa"]]);
var O, L;
L =
	() => {
		var e;
...
O =
	class {
		...
		async fetch(r, t = {}) {
			var o;
			if (
				t.headers = L(), r.indexOf(".do") < 0 && (r += ".do"), o =
					await fetch(M + r, t), o.status === 401
			) {
...
({ auto_update: P } = k);
var Pe = {
	components: { src: ce, rArea: be, drive: Ae, btn: Me },
	setup: () => {
		var e, r, t;
		return (
			r = "\u5F00\u59CB\u5F55\u5236", e = V(r), t =
				...
				start: async () => {
					...
					localStorage.recing = 1, { avatarUrl: o, space: { used: m, max: u } } =
						...
						e.value =
							"\u8BF7\u4ED8\u8D39\u6269\u5BB9\u540E\u70B9\u6B64\u5F55\u5236", k.open(
							M + "?pay=true&user_token=" + localStorage.uid,
						)
					) : (e.value = r, Le.\u5F55, oe());
				},
			}
...
var sr = y(Pe, [["render", Re], ["__scopeId", "data-v-465d0ab4"]]);
